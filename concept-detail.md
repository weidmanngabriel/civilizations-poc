...
Der dargestellte Baum unterscheidet Grundberufe, Ressourcen-/Erfahrungsstufen, weiterführende Berufe, Gebäude und besondere Einrichtungen. Die Schule bleibt als Einrichtung sichtbar, ihre Lehrbeziehungen werden aus Gründen der Lesbarkeit bewusst nicht als einzelne Kanten gezeichnet. Von den aktuell bereits im PoC vorhandenen Bauoptionen sind **Wohnhaus, Farm, Brunnen, Schule und Kaserne** direkt vom Startknoten aus verfügbar. **Lager** folgt aus dem **Träger**, das **Sägewerk** aus dem **Holzfäller**. Berufsgebundene Gebäude wie Schreinerei, Töpferei, Steinmetzwerkstatt, Mühle und Bäckerei bleiben in ihren jeweiligen Berufswegen. Der grundlegende Militärpfad lautet weiterhin **Ungelernter Wikinger → Kaserne → Soldat**. Die Waffenhütte bleibt als separater fortgeschrittener Produktionszweig des Schmieds und ist keine Voraussetzung für die grundsätzliche Soldatenausbildung. Diese Darstellung ist weiterhin nur eine Übersicht und definiert noch keine echte Freischaltlogik.
