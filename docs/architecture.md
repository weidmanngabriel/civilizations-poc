...
```text
natural source -> extractor carries one unit -> personal work flag -> nearest free ground cell outside the flag's visible tile footprint -> loose ground stack -> pickup -> consumer/storage
```
