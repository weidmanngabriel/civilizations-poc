...
Nach erfolgreichem Abschluss kann der Schüler den gewählten Beruf ausüben, startet darin aber ohne zusätzliche praktische Berufserfahrung. Der Lehrer wird anschließend wieder seinem vorherigen Beruf und, sofern weiterhin möglich, seinem vorherigen Arbeitsplatz zugewiesen. Zusätzliche Waren werden während des Unterrichts aktuell nicht verbraucht.
