...
Nach der Bestätigung läuft der konkrete Kundschafter selbst zur Zielstelle. Für diesen ausdrücklichen Erweiterungsauftrag darf er direkt über begehbares Terrain navigieren, auch wenn das Ziel noch außerhalb des bestehenden Wegweisernetzes liegt. Erst an der Zielstelle beginnt der Bau. Das Errichten dauert **fünf simulierte Sekunden**, verbraucht **keine Ressourcen** und endet mit dem normalen Anlegen und Verbinden des Wegweisers. Der Wegweiser selbst und die sechs direkt angrenzenden Mikrozellen dürfen nicht von einem Gebäudegrundriss belegt werden. Wegweiser können angeklickt und über ihr eigenes Menü wieder abgerissen werden; ihre Verbindungen werden dabei entfernt.
