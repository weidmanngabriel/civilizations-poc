...
Die erste Tierart sind Hasen. Sie leben in kleinen Gruppen mit einem gemeinsamen Heimatpunkt, bleiben aber einzelne Simulationsobjekte. Im Normalzustand bewegen sie sich alle 4–8 Sekunden einige Schritte in einem leicht zick-zack-förmigen Hoppelmuster. Etwa alle 30 Sekunden erhält die Gruppe ein neues gemeinsames Wanderziel 10–15 Mikrozellen vom aktuellen Gruppenzentrum entfernt. Dieses Ziel beeinflusst jedes Tier nur leicht. Am stärksten zieht weiterhin das aktuelle Zentrum der eigenen Gruppe, danach der Heimatpunkt; zusätzlich bleibt individueller Zufall erhalten. Dadurch wandert die Gruppe als Ganzes langsam weiter, ohne als starre Formation zu laufen.
