...
export const BUILDING_SVG: Partial<Record<BuildingKind, string>> = {
  ...
  pottery2: svg('<path d="M4 18h16M6 18v-7l6-5 6 5v7M8 13h8M9 10h6" fill="none" stroke="currentColor" stroke-width="1.8"/>'),
  ...
  stonemason2: svg('<path d="M3 19h18M5 19l2-8h10l2 8M8 11l1-5h6l1 5M7 15h10" fill="none" stroke="currentColor" stroke-width="1.8"/>'),
  school: svg('<path d="M3 20h18M5 20V9l7-5 7 5v11M8 20v-7h8v7M9 10h6" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M12 4v5" stroke="currentColor" stroke-width="1.5"/>'),
  ...
  palisade: svg('<path d="M6 20V6l2-2 2 2v14M14 20V6l2-2 2 2v14M4 11h16M4 16h16" fill="none" stroke="currentColor" stroke-width="1.8"/>'),
};
