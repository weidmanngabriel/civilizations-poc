...
const FEATURE_LABELS: Record<PerformanceFeature, string> = {
  ...
  resourceBlockingSync: "Sim · Ressourcen-Blocking",
  resourceOutputMigration: "Sim · Ressourcen-Output auf Boden",
  ...
  wildlifeBlockedSteps: "↳ Wildlife · blockierte Schritte",
  wildlifeReplans: "↳ Wildlife · Replans nach Blockade",
  wildlifePastureSearch: "↳ Wildlife · lokale Weidezielsuche",
