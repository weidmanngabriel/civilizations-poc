...
- Idle production workers use the same input-trip mechanism as carriers and continue filling free input slots up to capacity, including while output capacity blocks production. Already incoming trips count against destination input capacity.
