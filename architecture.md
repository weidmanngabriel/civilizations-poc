...
- An exhausted forest keeps its already produced wood available as a normal logistics source. When no output, assigned worker or source transport remains, the old forest is marked retired and its tile becomes a road. Retired building records remain internally available only as historical/reference state.
